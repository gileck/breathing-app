...
Record each sample's source and licence when you add it. Template:
...
- Source file: `freesound_community-singing-bowl-strike-sound-84682.mp3`
- Author: _fill in from Freesound page_
- Licence: _confirm on Freesound page — Freesound Community uploads are CC0 unless marked otherwise_
- Notes: trimmed to first 3 s (active strike + decay), 1 s fade-out at 2 s, loudness-normalised to EBU R128 (I=-16, TP=-1.5), re-encoded mono 44.1 kHz Vorbis (quality 3, ~23 KB).
